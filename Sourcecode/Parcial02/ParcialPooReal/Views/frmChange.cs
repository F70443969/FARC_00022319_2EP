...
namespace ParcialPooReal.Views
{
    public partial class frmChange : Form
    {
        ...
        private void fillCombo()
        {
            ...
            cmbUsers.DataSource = DBuser.GetUsers();
        }
        ...
        private void btnChange_Click(object sender, EventArgs e)
        {
            ...
            {
                if (DBuser.getIfPasswordMatch(user.userName, txtOldPass.Text))
                {
                    if (txtPass.Text == txtConfirmPass.Text)
                    {
                        DBuser.changeUserPassword(user.userName, txtConfirmPass.Text);
                        MessageBox.Show("Operacion realizada exitosamente", "Alerta", MessageBoxButtons.OK,
                            MessageBoxIcon.Information);
                        originForm.fillCombo();

                    }
                    else
                        MessageBox.Show("Las claves no coinciden", "Alerta", MessageBoxButtons.OK,
                            MessageBoxIcon.Warning);
                }
                else
                    MessageBox.Show("La clave vieja es incorrecta", "Alerta", MessageBoxButtons.OK,
                        MessageBoxIcon.Warning);
